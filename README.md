...
This project automates plywood cutting using:
- ABB robot RAPID modules (.mod)
- Fusion360 CAM post-processing to generate spindle toolpaths
- Multiple 2D Contour operations executed sequentially for an optimized cutting route
...
Tools Used:
- Autodesk Fusion 360 CAM (2D Contours + post-processing)
